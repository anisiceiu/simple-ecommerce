...
namespace ECommerce.Infrastructure.Migrations
{
    ...
    [Migration("20260710093012_InvetoryTransaction_Migrate")]
    partial class InvetoryTransaction_Migrate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.ChatRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.Message", b =>
                {
                    b.HasOne("ECommerce.Domain.Entities.ChatRoom", "ChatRoom")
                        .WithMany("Messages")
